...
func (c *Index) Render() app.UI {
	return app.Div().Class("content").Body(
		app.P().Class("mb-4 has-text-centered").Text("This application presents various Homomorphic Encryption schemes to help teach how they work and could be implemented."),
