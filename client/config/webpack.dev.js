...
const API_ADDRESS = process.env.CLIENT_API_ADDRESS || 'api.homomorphic-encryption.vjpatel.me';
const BACKEND_ADDRESS = process.env.CLIENT_BACKEND_ADDRESS || 'api.homomorphic-encryption.vjpatel.me';
